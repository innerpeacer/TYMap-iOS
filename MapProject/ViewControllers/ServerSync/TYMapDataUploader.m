...
@interface TYMapDataUploader() <TYWebUploaderDelegate>
{
    TYMapUser *user;
...
@implementation TYMapDataUploader
...
- (void)uploadMapDataWithIndex:(int)index
{
    ...
    param[@"mapdatas"] = [TYWebObjectConverter prepareJsonString:[TYWebObjectConverter prepareMapDataObjectArray:dataArray]];
