...
@implementation IPLabelBorderCalculator
...
+ (IPLabelBorder *)getFacilityLabelBorder:(CGPoint)screenPoint
{
    ...
    return [IPLabelBorder borderWithXmin:xmin YMin:ymin Width:width Height:height];
}
...
//    double right = screenPoint.x + (textWidth + TEXT_OFFSET_X) * scale;
    ...
    return [IPLabelBorder borderWithXMin:left XMax:right YMin:top YMax:bottom];
}
