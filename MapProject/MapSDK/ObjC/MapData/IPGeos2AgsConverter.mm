...
@implementation IPGeos2AgsConverter

+ (AGSGeometry *)agsGeometryFromGeosGeometry:(geos::geom::Geometry *)geometry
{
    switch (geometry->getGeometryTypeId()) {
        case GEOS_POINT:
            return [IPGeos2AgsConverter agsPointFromGeosPoint:dynamic_cast<geos::geom::Point *>(geometry)];
            break;
            
        case GEOS_MULTIPOINT:
            return [IPGeos2AgsConverter agsMultiPointFromGeosMultiPoint:dynamic_cast<geos::geom::MultiPoint *>(geometry)];
            break;
            
        case GEOS_LINESTRING:
            return [IPGeos2AgsConverter agsPolylineFromGeosLineString:dynamic_cast<geos::geom::LineString *>(geometry)];
            break;
            
        case GEOS_LINEARRING:
            return [IPGeos2AgsConverter agsPolylineFromGeosLinearRing:dynamic_cast<geos::geom::LinearRing *>(geometry)];
            break;
            
        case GEOS_MULTILINESTRING:
            return [IPGeos2AgsConverter agsPolylineFromGeosMultiLineString:dynamic_cast<geos::geom::MultiLineString *>(geometry)];
            break;
            
        case GEOS_POLYGON:
            return [IPGeos2AgsConverter agsPolygonFromGeosPolygon:dynamic_cast<geos::geom::Polygon *>(geometry)];
            break;
            
        case GEOS_MULTIPOLYGON:
            return [IPGeos2AgsConverter agsPolygonFromGeosMultiPolygon:dynamic_cast<geos::geom::MultiPolygon *>(geometry)];
            break;
