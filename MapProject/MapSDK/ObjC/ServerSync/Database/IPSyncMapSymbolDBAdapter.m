...
@interface IPSyncMapSymbolDBAdapter()
{
    sqlite3 *_database;
    NSString *dbPath;
}
...
@implementation IPSyncMapSymbolDBAdapter
...
{
    int count = 0;
    for (IPSyncFillSymbolRecord *fillRecord in fillSymbols) {
...
{
    int count = 0;
    for (IPSyncIconSymbolRecord *iconRecord in iconSymbols) {
