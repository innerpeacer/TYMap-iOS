...
@implementation TYSyncMapDataRecord
...
//    record.geometryData = [TYBase64Encoding decodingString:recordObject[FIELD_MAP_DATA_2_GEOMETRY]];
    record.geometryData = [[TYBase64Encoding decodingString:recordObject[FIELD_MAP_DATA_2_GEOMETRY]] gunzippedData];
...
//    [dataObject setObject:[TYBase64Encoding encodeingData:record.geometryData] forKey:FIELD_MAP_DATA_2_GEOMETRY];
    [dataObject setObject:[TYBase64Encoding encodeingData:[record.geometryData gzippedData]] forKey:FIELD_MAP_DATA_2_GEOMETRY];
